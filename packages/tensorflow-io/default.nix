...
let
  ...
  pname = "tensorflow-io${variant}";

  src = fetchFromGitHub {
    owner = "tensorflow";
    repo = "io";
    rev = "v${version}";
    sha256 = "sha256-o/kjSKpLMEg3zkKLOBhykOeY/quhAlC3QxYSHvFtMR8=";
  };
...
in buildPythonPackage {
  ...
  inherit (bazel-build) meta;
          ...
          tensorflow-io = buildPythonPackage rec {
            pname = "tensorflow-io";
            version = "0.28.0";
            src = fetchFromGitHub {
              owner = "tensorflow";
            ...
            postPatch = ''
              sed -i setup.py \
                -e 's/subpackages = ."tensorflow-io-gcs-filesystem"./subpackages = []/'
            '';
            #doCheck = false;
          };
